...
- [🛠️ Using Linux \& Linux Tools for Network Diagnostics](#️-using-linux--linux-tools-for-network-diagnostics)
  - [🎯 What We Will Cover](#-what-we-will-cover)
  - [⚙️ Technical Requirements](#️-technical-requirements)
  - [🧰 Your Network Diagnostic Toolkit](#-your-network-diagnostic-toolkit)
    - [🖥️ Native \& Standard Linux Tools](#️-native--standard-linux-tools)
    - [🔎 Advanced Scanning \& Wireless Tools](#-advanced-scanning--wireless-tools)
- [🌐 Network Basics: The OSI Model](#-network-basics-the-osi-model)
  - [📘 Overview](#-overview)
  - [📊 The 7 Layers of the OSI Model](#-the-7-layers-of-the-osi-model)
    - [🏗️ Detailed Layer Breakdown (Extracted from Diagram)](#️-detailed-layer-breakdown-extracted-from-diagram)
  - [🗣️ Common Usage in Troubleshooting](#️-common-usage-in-troubleshooting)
    - [🤔 The "Fuzzy" Areas](#-the-fuzzy-areas)
    - [😂 The "Layer 8" Joke](#-the-layer-8-joke)
  - [🔄 Data Travel: Encapsulation \& Decapsulation](#-data-travel-encapsulation--decapsulation)
    - [📉 The Journey of Data (Down and Up)](#-the-journey-of-data-down-and-up)
  - [📦 Media Layers vs. Host Layers](#-media-layers-vs-host-layers)
    - [🤝 Why This Matters (Interoperability)](#-why-this-matters-interoperability)
- [🛡️ Layer 2: Relating IP and MAC Addresses Using ARP](#️-layer-2-relating-ip-and-mac-addresses-using-arp)
  - [📘 Chapter Overview](#-chapter-overview)
  - [🆔 Understanding MAC Addresses](#-understanding-mac-addresses)
    - [🧠 What is a MAC Address?](#-what-is-a-mac-address)
    - [🔄 How Communication Works (The ARP Process)](#-how-communication-works-the-arp-process)
  - [📋 The ARP Cache: Viewing Your Local Table](#-the-arp-cache-viewing-your-local-table)
    - [💻 Command: `arp -a`](#-command-arp--a)
    - [🔍 Detailed Explanation of Your Output](#-detailed-explanation-of-your-output)
  - [⏱️ ARP Timers \& The `/proc` Directory](#️-arp-timers--the-proc-directory)
    - [📂 What is `/proc`?](#-what-is-proc)
    - [💻 Checking ARP Timeout](#-checking-arp-timeout)
  - [📊 Viewing Network Statistics](#-viewing-network-statistics)
    - [💻 Command: `cat /proc/net/dev`](#-command-cat-procnetdev)
    - [🔍 Analysis of Your Stats](#-analysis-of-your-stats)
  - [🛠️ Managing ARP Entries Manually](#️-managing-arp-entries-manually)
    - [1. Adding a Static Entry](#1-adding-a-static-entry)
    - [2. Deleting an Entry](#2-deleting-an-entry)
    - [3. Masquerading (Proxy ARP)](#3-masquerading-proxy-arp)
  - [🎭 Changing the MAC Address (Spoofing)](#-changing-the-mac-address-spoofing)
    - [❓ Why Change a MAC Address?](#-why-change-a-mac-address)
    - [🔍 Finding Your MAC Address](#-finding-your-mac-address)
    - [⚙️ Method 1: The Temporary Way (Command Line)](#️-method-1-the-temporary-way-command-line)
    - [⚙️ Method 2: The Permanent Way (Netplan)](#️-method-2-the-permanent-way-netplan)
    - [Apply the Configuration:](#apply-the-configuration)
- [🛠️ Changing MAC Address via Udev Rules](#️-changing-mac-address-via-udev-rules)
  - [📂 Purpose of the File](#-purpose-of-the-file)
  - [💻 Code Breakdown](#-code-breakdown)
  - [🚀 Step-by-Step Implementation](#-step-by-step-implementation)
    - [Step 1: Create the Rule File](#step-1-create-the-rule-file)
    - [Step 2: Add the Rule](#step-2-add-the-rule)
    - [Step 3: Save and Reboot](#step-3-save-and-reboot)
  - [⚖️ Netplan vs. Udev: Which is Better?](#️-netplan-vs-udev-which-is-better)
- [🏷️ MAC Address OUI Values](#️-mac-address-oui-values)
  - [📘 Overview](#-overview-1)
  - [🧩 The Structure of a MAC Address](#-the-structure-of-a-mac-address)
    - [1. The Manufacturer (OUI)](#1-the-manufacturer-oui)
    - [2. The Device ID (NIC Specific)](#2-the-device-id-nic-specific)
    - [📉 Visual Breakdown](#-visual-breakdown)
  - [📚 The Registries: Who Tracks This?](#-the-registries-who-tracks-this)
    - [1. The Official IEEE Registry](#1-the-official-ieee-registry)
    - [2. The Wireshark Registry](#2-the-wireshark-registry)
  - [🔍 Practical Use: Network Troubleshooting](#-practical-use-network-troubleshooting)
  - [🛠️ Tools for OUI Lookup](#️-tools-for-oui-lookup)
    - [🌐 Web-Based Lookup](#-web-based-lookup)
    - [💻 Command-Line Parser](#-command-line-parser)
  - [🚀 Next Steps: Moving Up the Stack](#-next-steps-moving-up-the-stack)
- [🚦 Layer 4: How TCP and UDP Ports Work](#-layer-4-how-tcp-and-udp-ports-work)
  - [📘 Overview](#-overview-2)
  - [🔗 The Connection Process](#-the-connection-process)
    - [🎲 Ephemeral Ports (The Source)](#-ephemeral-ports-the-source)
    - [🎯 Server Ports (The Destination)](#-server-ports-the-destination)
  - [🧩 The "5-Tuple" Concept](#-the-5-tuple-concept)
  - [🔢 Port Number Ranges](#-port-number-ranges)
  - [📋 Common Standard Ports](#-common-standard-ports)
  - [🏛️ The IANA Registry vs. Reality](#️-the-iana-registry-vs-reality)
- [🤝 Layer 4: TCP and the Three-Way Handshake](#-layer-4-tcp-and-the-three-way-handshake)
  - [📘 Overview: UDP vs. TCP](#-overview-udp-vs-tcp)
    - [🚀 UDP: The "Fire and Forget" Protocol](#-udp-the-fire-and-forget-protocol)
    - [🛡️ TCP: The Reliable Protocol](#️-tcp-the-reliable-protocol)
  - [🤝 The TCP Three-Way Handshake](#-the-tcp-three-way-handshake)
    - [1️⃣ Step 1: The Client Says "Hello" (SYN)](#1️⃣-step-1-the-client-says-hello-syn)
    - [2️⃣ Step 2: The Server Replies (SYN-ACK)](#2️⃣-step-2-the-server-replies-syn-ack)
    - [3️⃣ Step 3: The Client Confirms (ACK)](#3️⃣-step-3-the-client-confirms-ack)
    - [4️⃣ Step 4: Data Transfer](#4️⃣-step-4-data-transfer)
  - [🛑 Ending the Connection](#-ending-the-connection)
    - [🍂 Graceful Termination (The Polite Goodbye)](#-graceful-termination-the-polite-goodbye)
    - [💥 Ungraceful Termination (The "Hang Up")](#-ungraceful-termination-the-hang-up)
- [🔍 Local Port Enumeration: What Am I Connected To?](#-local-port-enumeration-what-am-i-connected-to)
  - [📘 Overview](#-overview-3)
  - [💻 The Command: `netstat -tuan`](#-the-command-netstat--tuan)
    - [🛠️ Command Breakdown](#️-command-breakdown)
  - [📊 Analyzing the Output](#-analyzing-the-output)
    - [🔍 Column Explanation](#-column-explanation)
  - [🚦 Understanding TCP States](#-understanding-tcp-states)
    - [1️⃣ Common States (Stable)](#1️⃣-common-states-stable)
    - [2️⃣ Transient States (Connection Setup)](#2️⃣-transient-states-connection-setup)
    - [3️⃣ Transient States (Connection Teardown)](#3️⃣-transient-states-connection-teardown)
- [🛠️ Advanced Port Enumeration: Linking Processes to Ports](#️-advanced-port-enumeration-linking-processes-to-ports)
  - [📘 Overview](#-overview-4)
  - [🔍 Identifying the Process: `netstat -tulpn`](#-identifying-the-process-netstat--tulpn)
    - [💻 Command Execution](#-command-execution)
    - [📊 Output Analysis](#-output-analysis)
  - [🚀 The Modern Alternative: `ss`](#-the-modern-alternative-ss)
    - [💻 Command: `ss -tulpn`](#-command-ss--tulpn)
    - [🔍 Comparison: `ss` vs `netstat`](#-comparison-ss-vs-netstat)
  - [✂️ Advanced Formatting: Piping \& Cutting](#️-advanced-formatting-piping--cutting)
    - [The Goal](#the-goal)
    - [The Tools](#the-tools)
    - [💻 The Magic Command](#-the-magic-command)
    - [📤 Clean Output](#-clean-output)
    - [💾 Exporting to a File (Redirection)](#-exporting-to-a-file-redirection)
  - [⚡ Power User Trick: `tee` and `grep`](#-power-user-trick-tee-and-grep)
    - [💻 Command](#-command)
    - [📤 Output](#-output)
  - [🕵️ Troubleshooting with `ss` Options](#️-troubleshooting-with-ss-options)
    - [💻 Command: `ss -to`](#-command-ss--to)
  - [📂 The "Everything is a File" Concept: `lsof`](#-the-everything-is-a-file-concept-lsof)
    - [💻 Command: `lsof -i :port`](#-command-lsof--i-port)
  - [❓ Why Does This Matter?](#-why-does-this-matter)
- [🛠️ Remote Port Enumeration Using Native Tools](#️-remote-port-enumeration-using-native-tools)
  - [📘 Introduction](#-introduction)
  - [📞 Tool 1: Telnet (The Quick Check)](#-tool-1-telnet-the-quick-check)
    - [💻 Practical Example: Telnetting to Google](#-practical-example-telnetting-to-google)
  - [🐱 Tool 2: Netcat (`nc`) - The Swiss Army Knife](#-tool-2-netcat-nc---the-swiss-army-knife)
    - [🚩 Key Flags](#-key-flags)
    - [💻 Scenario 1: Scanning Specific Ports](#-scenario-1-scanning-specific-ports)
    - [💻 Scenario 2: Scanning a Port Range (1-1024)](#-scenario-2-scanning-a-port-range-1-1024)
    - [💻 Scenario 3: Scanning UDP Ports](#-scenario-3-scanning-udp-ports)
  - [🏗️ Netcat as a Server: Creating a Fake Website](#️-netcat-as-a-server-creating-a-fake-website)
    - [1️⃣ The "Permission Denied" Error](#1️⃣-the-permission-denied-error)
    - [2️⃣ The Solution: Use High Ports](#2️⃣-the-solution-use-high-ports)
  - [📂 Transferring Files with Netcat](#-transferring-files-with-netcat)
    - [📥 Step 1: The Receiver (Start this first)](#-step-1-the-receiver-start-this-first)
    - [📤 Step 2: The Sender](#-step-2-the-sender)
    - [✅ Step 3: Verification](#-step-3-verification)
- [📜 Nmap Scripting Engine (NSE) \& Advanced Scanning](#-nmap-scripting-engine-nse--advanced-scanning)
  - [📘 Overview](#-overview-5)
  - [🛡️ Case Study: Scanning for SMB Vulnerabilities](#️-case-study-scanning-for-smb-vulnerabilities)
    - [❓ The Problem: SMBv1 \& EternalBlue](#-the-problem-smbv1--eternalblue)
    - [🧪 Practical Example 1: Checking SMB Protocols](#-practical-example-1-checking-smb-protocols)
    - [🧪 Practical Example 2: Checking for Specific Vulnerabilities](#-practical-example-2-checking-for-specific-vulnerabilities)
- [🧰 Essential Nmap Scripts for Administrators](#-essential-nmap-scripts-for-administrators)
  - [🏴‍☠️ 1. Finding "Shadow IT" (Unexpected Servers)](#️-1-finding-shadow-it-unexpected-servers)
  - [🕸️ 2. Unexpected or Malicious Infrastructure](#️-2-unexpected-or-malicious-infrastructure)
  - [💻 3. Workstation Issues](#-3-workstation-issues)
  - [🏰 4. Network Perimeter \& Server Problems](#-4-network-perimeter--server-problems)
  - [📏 5. Network Path Troubleshooting (MTU)](#-5-network-path-troubleshooting-mtu)
  - [🛠️ 6. Certificates \& Encryption Audits](#️-6-certificates--encryption-audits)
  - [⏳ The Limits of Nmap](#-the-limits-of-nmap)
    - [1. The Scaling Problem](#1-the-scaling-problem)
    - [2. Solutions for Speed](#2-solutions-for-speed)
